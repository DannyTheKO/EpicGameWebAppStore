...
CREATE TABLE IF NOT EXISTS `EpicGameWebApp`.`Cart` (
  ...
  `CreatedOn` DATETIME NULL DEFAULT NULL,
  `CartStatus` ENUM("Active", "Completed") NULL DEFAULT 'Completed',
  PRIMARY KEY (`CartID`),
...
CREATE TABLE IF NOT EXISTS `EpicGameWebApp`.`ImageGame` (
  `ImageGameID` INT NOT NULL AUTO_INCREMENT,
  `GameID` INT NOT NULL,
  `ImageType` ENUM("Banner", "Thumbnail", "Screenshot", "Background") NOT NULL DEFAULT 'Thumbnail',
  `FileName` VARCHAR(255) NOT NULL,
  `FilePath` VARCHAR(255) NULL,
  `CreatedOn` DATETIME NULL,
  PRIMARY KEY (`ImageGameID`),
