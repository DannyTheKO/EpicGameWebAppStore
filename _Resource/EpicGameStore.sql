...
CREATE UNIQUE INDEX `Code_UNIQUE` ON `EpicGameWebApp`.`Discount` (`Code` ASC) VISIBLE;
...
CREATE INDEX `FK_AccountGame_Account_INDEX` ON `EpicGameWebApp`.`AccountGame` (`AccountID` ASC) INVISIBLE;
