...
-- -----------------------------------------------------
-- Table `EpicGameWebApp`.`Roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `EpicGameWebApp`.`Roles` ;

CREATE TABLE IF NOT EXISTS `EpicGameWebApp`.`Roles` (
...
CREATE TABLE IF NOT EXISTS `EpicGameWebApp`.`Account` (
  ...
  CONSTRAINT `FK_Account_Roles`
    FOREIGN KEY (`RoleId`)
    REFERENCES `EpicGameWebApp`.`Roles` (`RoleId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `FK_Account_Roles_idx` ON `EpicGameWebApp`.`Account` (`RoleId` ASC) VISIBLE;
