...
-- -----------------------------------------------------
-- Table `EpicGameWebApp`.`Image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `EpicGameWebApp`.`Image` ;

CREATE TABLE IF NOT EXISTS `EpicGameWebApp`.`Image` (
...
CREATE INDEX `GameID_INDEX` ON `EpicGameWebApp`.`Image` (`GameID` ASC) INVISIBLE;
